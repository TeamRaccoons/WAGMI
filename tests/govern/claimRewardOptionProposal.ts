...
describe("Locked voter", () => {
    ...
    async function createLFGProposal() {
        ...
        //     ],
        // };
        const proposal = await createOptionProposal(govern, [], governProgram, maxOption);
        ...
        await createOptionProposalMeta(
            proposal,
            optionDescriptions,
            governProgram
        );
    ...
    before(async () => {
        ...
        proposal = await createLFGProposal();
